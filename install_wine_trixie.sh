...
echo "deb [signed-by=/usr/share/keyrings/winehq-archive.keyring] https://dl.winehq.org/wine-builds/debian/ trixie main" | sudo tee /etc/apt/sources.list.d/winehq.list
